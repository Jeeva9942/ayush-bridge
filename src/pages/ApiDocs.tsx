      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-xl text-muted-foreground">
            Comprehensive documentation for AyushBridge API endpoints and integration guide.
          </p>
        </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  The AyushBridge API provides programmatic access to our NAMASTE to ICD-11 conversion services. 
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <code className="bg-muted px-2 py-1 rounded text-sm">https://api.ayushbridge.com/v1</code>
                  </div>
                  <div className="space-y-2">
...
{`{
  "success": true,
  "data": {
    "icd11_tm2_code": "1C62.Z",
    "icd11_tm2_term": "Fever, unspecified",
    "icd11_bio_code": "MD11.Z",
    "icd11_bio_term": "Fever syndrome",
    "confidence": 0.92
  }
}`}
                      </pre>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Upload CSV file with multiple NAMASTE codes for batch conversion</p>
                  <div className="space-y-4">
                    <div>
                      <h5 className="font-semibold mb-2">Request (Multipart Form)</h5>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`Content-Type: multipart/form-data

file: [CSV file with columns: namaste_code, namaste_term]
...
{`{
  "success": true,
  "processed_count": 150,
  "fhir_bundle": "https://api.ayushbridge.com/bundles/uuid",
  "download_url": "https://api.ayushbridge.com/download/uuid.json"
}`}
                      </pre>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Retrieve mapping details for a specific NAMASTE code</p>
                  <div className="space-y-4">
                    <div>
                      <h5 className="font-semibold mb-2">Response</h5>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`{
  "namaste_code": "A001.01",
  "namaste_term": "Fever due to Pitta imbalance",
  "icd11_mappings": {
    "tm2": {
      "code": "1C62.Z",
      "term": "Fever, unspecified"
    },
    "biomedicine": {
      "code": "MD11.Z", 
      "term": "Fever syndrome"
  ...
  "confidence_score": 0.92
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Get latest updates on coding standards and mappings</p>
                  <div className="space-y-4">
                    <div>
                      <h5 className="font-semibold mb-2">Response</h5>
                      <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
  ...
  "updates": [
    {
      ...
      "date": "2025-01-15",
      "changes": [
        "Added 150 new NAMASTE codes",
        "Improved ICD-11 mapping accuracy",
...
const convertCode = async (namasteCode) => {
  try {
    const response = await axios.post(
      'https://api.ayushbridge.com/v1/single-upload',
      {
...
def convert_code(namaste_code):
    url = "https://api.ayushbridge.com/v1/single-upload"
    headers = {
        "Authorization": "Bearer YOUR_API_KEY",
        "Content-Type": "application/json"
    }
    ...
    return response.json()`}
                ...
                <div>
                  ...
                  <pre className="bg-muted p-4 rounded-lg text-sm overflow-x-auto">
{`curl -X POST https://api.ayushbridge.com/v1/single-upload \\
