...
import { ArrowRight, Heart, Shield, Zap, Globe, Users, Activity, BookOpen, FileText, Stethoscope, Leaf, Brain, Sparkles } from "lucide-react";
import { Link } from "react-router-dom";
import heroImage from "@/assets/hero-medical-tech.jpg";
import collaborationImage from "@/assets/ayurveda-modern-collaboration.jpg";
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="space-y-4">
                <h1 className="text-3xl sm:text-4xl lg:text-6xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent leading-tight">
                  Bridge Ancient Wisdom & Modern Medicine
                </h1>
                <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed">
                  Seamlessly convert between ICD-11 and NAMASTE medical codes with our advanced AI-powered platform. 
                  Enhancing interoperability across traditional Ayurveda and modern medical systems.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <Card className="p-4 sm:p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent className="pt-0">
                <CardDescription className="text-center text-sm sm:text-base">
                  Advanced security ensuring your medical data remains protected and compliant.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="p-4 sm:p-6 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <CardContent className="pt-0">
                <CardDescription className="text-center text-sm sm:text-base">
                  Support for international medical coding standards including ICD-11 and NAMASTE systems.
                </CardDescription>
              </CardContent>
            </Card>
